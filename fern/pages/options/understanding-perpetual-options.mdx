...
<CardGroup cols={3}>
  ...
  <Card title="Funding Period" icon="fa-solid fa-clock">
    <p class="text-sm">Set at 120 hours for continuous funding</p>
  </Card>
</CardGroup>
...
- **Funding Period:** 120 hours (funding is paid continuously)
...
<Tip title="Core Idea" icon="leaf">
The Funding Period is a critical concept to understand. It represents the expected period of time over which a user will pay the time value of the option via Funding. This is a parameter chosen by Paradex and is what makes the current Perpetual Option similar (but not equal to) a 120 hour dated option.
</Tip>
